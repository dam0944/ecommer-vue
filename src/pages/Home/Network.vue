<template>
  <div class="rounded-sm mb-8 px-4 py-6 max-w-full">
    <div class="relative">
      <!-- Navigation Buttons -->
      <button
        @click="slideLeft"
      ...
      <div class="flex justify-between items-center pb-2">
        <h2 class="font-bold text-gray-900 mb-3 text-2xl">Computer</h2>
        <span>
          <router-link
            to="/product-grid"
...
<!-- No scoped style: all styles are now TailwindCSS classes -->